...
<div class="eleven columns">
	...
	<div class="seven columns column">
		<p>IrScan-S200 通过大功率红外辐射扫描进行热激励，具有加热均匀、波长范围宽和稳定可靠等优点，适用于各种金属、非金属及复合材料的检测。
...
<hr/>
	...
	  <img src="../images/products/table_en_irscan2.png" />
	</div>

	<div id="applications" class="tabcontent">
	  <p>
		一个典型应用范例如下图所示，试件为一玻璃纤维风电叶片，检测玻璃纤维叶片粘接质量。玻璃纤维导热慢，需要较高能量热激励和长时间的采集，红外辐射扫描热激励完全适合于此类缺陷的检测。

</p>
		<div class="four columns">
			<img src="../images/products/app_air1.png" />
		</div>
		<div class="four columns">
    	<img src="../images/products/app_air2.png" />
		</div>
	</div>
</div>
</div>
